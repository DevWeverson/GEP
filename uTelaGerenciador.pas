...
begin
   ...
   try
      Fcadastroproduto.Action := 'incluir';
...
procedure TGEP.excluirClick(Sender: TObject);
var
  Id: Integer;
begin
   Id := DM.FDQuery.FieldByName('codpro').AsInteger;
   DM.FDQuery.Close;
   DM.FDQuery.SQL.Clear;
   DM.FDQuery.SQL.Add('DELETE FROM Produtos WHERE Codpro = :codigo');

   DM.FDQuery.ParamByName('codigo').AsInteger := Id;
